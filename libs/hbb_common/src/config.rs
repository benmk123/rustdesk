...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("pspro-cellcom".to_owned());
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["support.pspro.co.il"];
pub const RS_PUB_KEY: &str = "CWnOkyqbP44a+UzG8fOi2S5YeOXOLTIAZIke2pb1kik=";
